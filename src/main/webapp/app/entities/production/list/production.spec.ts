...
import { sampleWithRequiredData } from '../production.test-samples';
...
describe('Production Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.productions()[0]).toEqual(expect.objectContaining({ id: 25690 }));
  });

  describe('trackId', () => {
    it('should forward to productionService', () => {
      const entity = { id: 25690 };
      vitest.spyOn(service, 'getProductionIdentifier');
