...
import { sampleWithRequiredData } from '../tenant-settings.test-samples';

import { TenantSettings } from './tenant-settings';

describe('TenantSettings Management Component', () => {
  let comp: TenantSettings;
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tenantSettings()[0]).toEqual(expect.objectContaining({ id: 15390 }));
  });

  describe('trackId', () => {
    it('should forward to tenantSettingsService', () => {
      const entity = { id: 15390 };
      vitest.spyOn(service, 'getTenantSettingsIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTenantSettingsIdentifier).toHaveBeenCalledWith(entity);
