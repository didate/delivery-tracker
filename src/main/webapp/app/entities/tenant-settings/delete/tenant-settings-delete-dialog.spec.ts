...
import { TenantSettingsDeleteDialog } from './tenant-settings-delete-dialog';

describe('TenantSettings Management Delete Component', () => {
  let comp: TenantSettingsDeleteDialog;
  let fixture: ComponentFixture<TenantSettingsDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TenantSettingsDeleteDialog);
