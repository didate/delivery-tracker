...
import { ReturnItemDeleteDialog } from './return-item-delete-dialog';

describe('ReturnItem Management Delete Component', () => {
  let comp: ReturnItemDeleteDialog;
  let fixture: ComponentFixture<ReturnItemDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ReturnItemDeleteDialog);
