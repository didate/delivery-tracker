...
import { sampleWithRequiredData } from '../return-item.test-samples';
...
describe('ReturnItem Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.returnItems()[0]).toEqual(expect.objectContaining({ id: 28210 }));
  });

  describe('trackId', () => {
    it('should forward to returnItemService', () => {
      const entity = { id: 28210 };
      vitest.spyOn(service, 'getReturnItemIdentifier');
      const id = comp.trackId(entity);
      expect(service.getReturnItemIdentifier).toHaveBeenCalledWith(entity);
