...
export class PriceHistory implements OnInit {
  ...
  priceHistories = signal<IPriceHistory[]>([]);
  ...
  protected readonly priceHistoryService = inject(PriceHistoryService);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.priceHistories.set(dataFromBody);
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.priceHistoryService.query(queryObject).pipe(finalize(() => this.isLoading.set(false)));
  }
