...
describe('PriceHistory Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.priceHistories()[0]).toEqual(expect.objectContaining({ id: 5381 }));
  });

  describe('trackId', () => {
    it('should forward to priceHistoryService', () => {
      const entity = { id: 5381 };
      vitest.spyOn(service, 'getPriceHistoryIdentifier');
