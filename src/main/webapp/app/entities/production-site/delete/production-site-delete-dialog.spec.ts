...
import { ProductionSiteDeleteDialog } from './production-site-delete-dialog';

describe('ProductionSite Management Delete Component', () => {
  let comp: ProductionSiteDeleteDialog;
  let fixture: ComponentFixture<ProductionSiteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProductionSiteDeleteDialog);
