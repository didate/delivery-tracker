...
import { sampleWithRequiredData } from '../production-site.test-samples';
import { ProductionSiteService } from '../service/production-site.service';

import { ProductionSite } from './production-site';

describe('ProductionSite Management Component', () => {
  let comp: ProductionSite;
  let fixture: ComponentFixture<ProductionSite>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProductionSite);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.productionSites()[0]).toEqual(expect.objectContaining({ id: 20528 }));
  });

  describe('trackId', () => {
    it('should forward to productionSiteService', () => {
      const entity = { id: 20528 };
      vitest.spyOn(service, 'getProductionSiteIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProductionSiteIdentifier).toHaveBeenCalledWith(entity);
