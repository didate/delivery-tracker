...
describe('DeliveryItem Management Component', () => {
  let comp: DeliveryItem;
  let fixture: ComponentFixture<DeliveryItem>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DeliveryItem);
  ...
  describe('trackId', () => {
    it('should forward to deliveryItemService', () => {
      ...
      vitest.spyOn(service, 'getDeliveryItemIdentifier');
