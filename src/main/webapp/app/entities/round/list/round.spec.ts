...
import { sampleWithRequiredData } from '../round.test-samples';
...
describe('Round Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.rounds()[0]).toEqual(expect.objectContaining({ id: 19799 }));
  });

  describe('trackId', () => {
    it('should forward to roundService', () => {
      const entity = { id: 19799 };
      vitest.spyOn(service, 'getRoundIdentifier');
