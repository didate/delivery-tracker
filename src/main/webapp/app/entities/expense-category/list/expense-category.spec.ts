...
describe('ExpenseCategory Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.expenseCategories()[0]).toEqual(expect.objectContaining({ id: 17564 }));
  });

  describe('trackId', () => {
    it('should forward to expenseCategoryService', () => {
      const entity = { id: 17564 };
      vitest.spyOn(service, 'getExpenseCategoryIdentifier');
