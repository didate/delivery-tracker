...
describe('ExpenseCategory Management Detail Component', () => {
  let comp: ExpenseCategoryDetail;
  let fixture: ComponentFixture<ExpenseCategoryDetail>;
      ...
      providers: [
        provideRouter(
          [
            {
              path: '**',
              loadComponent: () => import('./expense-category-detail').then(m => m.ExpenseCategoryDetail),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ExpenseCategoryDetail);
  ...
  describe('OnInit', () => {
    it('should load expenseCategory on init', async () => {
      ...
      const instance = await harness.navigateByUrl('/', ExpenseCategoryDetail);
