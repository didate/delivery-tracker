...
export class ProductReturn implements OnInit {
  ...
  productReturns = signal<IProductReturn[]>([]);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.productReturns.set(dataFromBody);
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.productReturnService.query(queryObject).pipe(finalize(() => this.isLoading.set(false)));
  }
