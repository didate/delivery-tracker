...
describe('ProductReturn Management Component', () => {
  let comp: ProductReturn;
  let fixture: ComponentFixture<ProductReturn>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProductReturn);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.productReturns()[0]).toEqual(expect.objectContaining({ id: 8123 }));
  });

  describe('trackId', () => {
    it('should forward to productReturnService', () => {
      const entity = { id: 8123 };
      vitest.spyOn(service, 'getProductReturnIdentifier');
