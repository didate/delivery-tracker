...
import { ProductReturnDeleteDialog } from './product-return-delete-dialog';

describe('ProductReturn Management Delete Component', () => {
  let comp: ProductReturnDeleteDialog;
  let fixture: ComponentFixture<ProductReturnDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProductReturnDeleteDialog);
