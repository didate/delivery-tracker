...
import { PaymentDeleteDialog } from '../delete/payment-delete-dialog';
...
export class Payment implements OnInit {
  ...
  delete(payment: IPayment): void {
    const modalRef = this.modalService.open(PaymentDeleteDialog, { size: 'lg', backdrop: 'static' });
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.paymentService.query(queryObject).pipe(finalize(() => this.isLoading.set(false)));
  }
