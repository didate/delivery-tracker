...
/**
 * REST controller for managing {@link com.delivery.domain.ExpenseCategory}.
 */
@RestController
...
public class ExpenseCategoryResource {
    ...
    public ResponseEntity<ExpenseCategoryDTO> createExpenseCategory(@Valid @RequestBody ExpenseCategoryDTO expenseCategoryDTO)
        ...
        return ResponseEntity.created(new URI("/api/expense-categories/" + expenseCategoryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, expenseCategoryDTO.getId().toString()))
    ...
    public ResponseEntity<ExpenseCategoryDTO> updateExpenseCategory(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, expenseCategoryDTO.getId().toString()))
            .body(expenseCategoryDTO);
    }
    ...
    public ResponseEntity<ExpenseCategoryDTO> partialUpdateExpenseCategory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, expenseCategoryDTO.getId().toString())
        );
    }
