...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '68fe8c76-0d4e-45f5-9710-c41657893157' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('dcc6263a-abac-46dc-b0b4-6aeb4016a0a1');
      cy.get(`[data-cy="name"]`).should('have.value', 'dcc6263a-abac-46dc-b0b4-6aeb4016a0a1');
